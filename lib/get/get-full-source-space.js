...
function pagedGet (space, method, skip = 0, aggregatedResponse = null) {
  ...
  if (updatedSinceTS != null) {
    params['sys.updatedAt[gt]'] = updatedSinceTS
  }

  log.info('updated since: ' + params['sys.updatedAt[gt]'])

  return space[method](params)
  .then((response) => {
