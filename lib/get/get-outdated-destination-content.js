 ...
 */
export default function getOutdatedDestinationContent ({managementClient, spaceId, entryIds = [], assetIds = [], webhookIds = [], roles = [], skipContentModel, skipContent}) {
  ...
  return managementClient.getSpace(spaceId)
    .then((space) => {
      return Promise.props({
        ...
        roles: skipContentModel ? Promise.resolve([]) : space.getRoles().then(extractItems),
